...
if __name__ == '__main__':
    ...
    network_name='validation-network-%s-%d-net' %(user_name, time.time())
    ...
    process = multiprocessing.Process(target=network_test, args=(
        zone_id,
        network_name,
        template_id,
        domain_id,
    ...
    process.name = 'network_test@%s' % network_name
    process.start()
