...
if __name__ == '__main__':
    ...
    network_name='validation-template-%s-%d-net' %(user_name, time.time())
    ...
    process = multiprocessing.Process(target=template_test, args=(
        zone_id,
        network_name,
        template_id,
        domain_id,
    ...
    process.name = 'template_test@%s' % network_name
    process.start()
